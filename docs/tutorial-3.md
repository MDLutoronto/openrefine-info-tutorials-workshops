...
[Open regex101\.com and load some sample data](#open-regex101com-and-load-some-sample-data)

[Practice some regex basics](#practice-some-regex-basics)

[Use regex in OpenRefine](#use-regex-in-openrefine)
